...
def nlconyml_arg(tmp_directory):
    ...
    arg.to_cycle = "CY49t2"
    arg.format = "yaml"
    arg.output_reference = "deode/data/namelists/unit_testing/reference/nl_master_base.49t2.yml"
    return arg
...
def nlconftn_arg(tmp_directory):
    ...
    arg.to_cycle = "CY49t2"
    arg.format = "ftn"
    arg.output_reference = "deode/data/namelists/unit_testing/reference/nl_master_base.49t2"
    return arg
