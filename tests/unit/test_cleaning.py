...
from deode.cleaning import CleanDeode, wipe_ecfs
...
def test_defaults(basic_config):
    ...
    with contextlib.suppress(RuntimeError):
        CleanDeode(config, config.get_as_dict("cleaning.defaults"))
...
def test_cycle_length_exception(basic_config):
    config = basic_config
    cleaner = CleanDeode(config, config.get_as_dict("cleaning.defaults"))
...
def test_basetime(basic_config):
    ...
    cleaner = CleanDeode(config, config.get_as_dict("cleaning.defaults"), basetime)
