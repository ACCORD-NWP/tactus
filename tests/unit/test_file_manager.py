...
class TestFileManager():
    ...
    def test_input_files(self, parsed_config_with_paths):
        ...
        provider, resource = fmanager.get_input("@ARCHIVE@/ICMSH@CNMEXP@+@LLLL@",
        ...
        provider, resource = fmanager.get_input("@BINDIR@/MASTERODB", "/tmp/MASTERODB")   # noqa S108, E501
        ...
        res_dict = {
            "input": {
                "/dev/null": {"destination": "/tmp/test", "provider_id": "symlink"}       # noqa S108, E501
            }
        }
    ...
    def test_output_files(self, parsed_config_with_paths):
        ...
        provider, aprovider, resource = \
            fmanager.get_output("/tmp/ICMSH@CNMEXP@+@LLLL@",                  # noqa S108
        ...
        assert provider.identifier == "/tmp/archive/2000/01/01/00/OUT_ICMSHDEOD+0024"     # noqa S108, E501
        assert os.path.exists("/tmp/archive/2000/01/01/00/OUT_ICMSHDEOD+0024")            # noqa S108, E501
        assert aprovider.identifier == "ectmp:/2000/01/01/00/OUT_ICMSHDEOD+0024"          # noqa S108, E501
