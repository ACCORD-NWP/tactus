...
class FormattingOptions:
    """Options that control how the formatting is performed."""

    indentation: int = 2
    section_order_overrides: Sequence[str] = ()
...
class FormattedTomlFileSection(BaseTomlContentsSequence):
    ...
    def __init__(self, data: Sequence[str], formatting_options: FormattingOptions = None):
        """Initialise instance."""
...
class FormattedToml(BaseMapping):
    ...
    def __init__(
        self, raw_data: Sequence[str], formatting_options: FormattingOptions = None
    ):
...
def _split_data_in_sections(
    entries: TomlFileEntriesContainer, formatting_options: FormattingOptions
