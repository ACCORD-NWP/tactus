...
##                }
keys_to_move = {('NAMDIM', 'NUNDEFLD'):('NAMCT0', 'NUNDEFLD'),
               ('NAMGEM', 'REFLKUO'):('NAMPHY0', 'REFLKUO'),
               ('NAMGEM', 'REFLCAPE'):('NAMPHY0', 'REFLCAPE'),
               ('NAMGEM', 'REFLRHC'):('NAMPHY0', 'REFLRHC'),
               ('NAMPAR0', 'LCOUPLO4'):('NAMCT0', 'LCOUPLO4'),
               }

# 4. Keys to be removed. Already missing keys are ignored.
# Blocks need to be consistent with above movings.
keys_to_remove = set([('NAMVWRK', 'NPCKSLTRAJ'),
                      ])
