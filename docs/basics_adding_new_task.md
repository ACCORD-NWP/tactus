...
```
deode -config_file=/your/config.toml -loglevel debug run --task yourtask  --template $PWD/ecf/stand_alone.py  --job $PWD/yourtask.job  --troika_config $PWD/config.yml  -o $PWD/yourtask.log
```
