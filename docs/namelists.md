...
The simplest way to change a namelist is to extract it as described above, make your modifications and add the namelist to the `data/namelist/` directory. The name of the namelist should be the same as when extracted above. Before the system will pick up your namelist you have to set `general.accept_stat_namelist = true` in the config file.
